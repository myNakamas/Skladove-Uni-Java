    ...
    public static SessionFactory getSessionFactory() {
        ...
        if (sessionFactory == null) {
            ...
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/db_skladove?useSSL=false&createDatabaseIfNotExist=true&serverTimezone=UTC&useLegacyDatetimeCode=false");
